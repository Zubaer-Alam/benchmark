...
function BlockquoteWithImage({ author, image, children, className }) {
  return (
    ...
    >
      <blockquote className="col-span-2 text-xl/7 text-neutral-100 sm:col-span-7 sm:col-start-6 sm:row-start-2">
      ...
      <figcaption className="text-sm text-neutral-200 sm:col-span-7 sm:row-start-3 sm:text-base">
  ...
  return (
    <Border position="left" className={clsx("pl-8", className)}>
      <figure className="text-sm">
        <blockquote className="text-neutral-50 [&>*]:relative [&>:first-child]:before:absolute [&>:first-child]:before:right-full [&>:first-child]:before:content-['“'] [&>:last-child]:after:content-['”']">
          {typeof children === "string" ? <p>{children}</p> : children}
        </blockquote>
        <figcaption className="mt-6 font-semibold text-neutral-200">
