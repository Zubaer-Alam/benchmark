...
const About = () => {
  return (
    <div
      id="about"
      className=" text-white relative md:-mt-[150px] -mt-10 bg-gradient-to-tr from-[#161616] to-[#080808] md:py-20 py-12 md:px-16 px-6 rounded-xl z-50 flex flex-col md:flex-row justify-between md:items-center gap-12"
    >
