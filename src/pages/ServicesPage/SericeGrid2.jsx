        ...
        {projects.map((project, idx) => (
          ...
          >
            <AnimatePresence>
              {hoveredIndex === idx && (
                <motion.span
                  className="absolute inset-0 h-full w-full bg-amber-200/[0.5] block  rounded-3xl"
            ...
            <div className=" rounded-2xl h-full w-full p-4 overflow-hidden bg-gradient-to-br from-yellow-100 to-amber-200/[0.2] border-transparent group-hover:border-neutral-700 relative z-50">
              <div className="relative z-50">
                <div className="p-4">
                  ...
                  <p className="mt-8 text-dark tracking-wide leading-relaxed text-sm">
                    {project.description}
                  </p>
                </div>
              </div>
