...
const gridItems = [
    ...
    },
    {
        ...
        <MdOutlineAssessment size={36} className='text-green-600' />
    </span>
    },
    {
    ...
    return (
        <div>
            <div className="px-3 md:lg:xl:px-40 border-t border-b py-20 bg-opacity-10">
                <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-zinc-50 shadow-xl shadow-neutral-100 border rounded-xl">
